...
DRPCoreConfig.StaffRanks.perms = { -- This is what you need to reference too in the database for your rank :)
    ...
    ["admin"] = {"time", "weather", "adminaddcop", "heal", "teleport", "vehicle", "clearchat"}, -- The Perms Admins Have
    ["superadmin"] = {"time", "weather", "adminaddcop", "heal", "addgroup", "teleport", "economy", "adminmenu", "kick", "ban", "vehicle", "clearchat"} -- The Perms Superadmins have
}
---------------------------------------------------------------------------
